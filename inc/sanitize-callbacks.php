 ...
 */
function vendeur_sanitize_layout($value) {
 ...
 */
function vendeur_sanitize_color_field($value) {
	return $value;
}
 ...
 * @return HTML string sanitized with wpkses.
 */
function vendeur_sanitize_blog_list_view($value) {
 ...
 * @return HTML string sanitized with wpkses.
 */
function vendeur_sanitize_footer_credit($value) {
	$allowed_tags = array(
						'a' => array(
							'href' => array(),
							'title' => array(),
 ...
 */
function vendeur_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function vendeur_sanitize_number_absint( $number, $setting ) {
 ...
 */
function vendeur_sanitize_image( $image, $setting ) {
	/*
